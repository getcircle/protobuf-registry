...
public final class GetProfilesResponseV1 extends Message {
  ...
  public GetProfilesResponseV1(Integer version, List<ProfileV1> profiles) {
    this.version = version;
    this.profiles = immutableCopyOf(profiles);
  }

  private GetProfilesResponseV1(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GetProfilesResponseV1)) return false;
    GetProfilesResponseV1 o = (GetProfilesResponseV1) other;
  ...
  public static final class Builder extends Message.Builder<GetProfilesResponseV1> {
    ...
    public Builder(GetProfilesResponseV1 message) {
      super(message);
    ...
    @Override
    public GetProfilesResponseV1 build() {
      return new GetProfilesResponseV1(this);
    }
  }
}
