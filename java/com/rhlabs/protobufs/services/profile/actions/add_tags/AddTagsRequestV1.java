...
// Source file: ./src/protobufs/services/profile/actions/add_tags.proto
package com.rhlabs.protobufs.services.profile.actions.add_tags;
...
public final class AddTagsRequestV1 extends Message {
  ...
  public AddTagsRequestV1(Integer version, List<TagV1> tags, String profile_id) {
    this.version = version;
    this.tags = immutableCopyOf(tags);
    this.profile_id = profile_id;
  }

  private AddTagsRequestV1(Builder builder) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof AddTagsRequestV1)) return false;
    AddTagsRequestV1 o = (AddTagsRequestV1) other;
  ...
  public static final class Builder extends Message.Builder<AddTagsRequestV1> {
    ...
    public Builder(AddTagsRequestV1 message) {
      super(message);
    ...
    @Override
    public AddTagsRequestV1 build() {
      return new AddTagsRequestV1(this);
    }
  }
}
