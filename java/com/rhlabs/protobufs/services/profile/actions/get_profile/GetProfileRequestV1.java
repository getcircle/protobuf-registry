...
public final class GetProfileRequestV1 extends Message {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GetProfileRequestV1)) return false;
  ...
  public static final class Builder extends Message.Builder<GetProfileRequestV1> {
    ...
    public Builder(GetProfileRequestV1 message) {
      super(message);
    ...
    @Override
    public GetProfileRequestV1 build() {
      return new GetProfileRequestV1(this);
    }
  }
}
