...
public final class MessageOptions extends ExtendableMessage<MessageOptions> {
  ...
  public MessageOptions(Boolean message_set_wire_format, Boolean no_standard_descriptor_accessor, Boolean deprecated, List<UninterpretedOption> uninterpreted_option) {
  ...
  private MessageOptions(Builder builder) {
    this(builder.message_set_wire_format, builder.no_standard_descriptor_accessor, builder.deprecated, builder.uninterpreted_option);
    setBuilder(builder);
  }
