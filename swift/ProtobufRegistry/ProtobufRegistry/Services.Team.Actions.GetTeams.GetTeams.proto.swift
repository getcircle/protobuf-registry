...
public extension Services.Team.Actions.GetTeams {
  ...
  final public class RequestV1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func setProfileId(value:String) -> Services.Team.Actions.GetTeams.RequestV1.Builder {
        self.profileId = value
        return self
      }
      public func clearProfileId() -> Services.Team.Actions.GetTeams.RequestV1.Builder{
