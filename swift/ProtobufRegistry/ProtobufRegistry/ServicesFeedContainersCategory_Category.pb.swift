...
import Foundation
public extension Services.Feed{ public struct Containers { public struct Category { }}}

public func == (lhs: Services.Feed.Containers.Category.CategoryV1, rhs: Services.Feed.Containers.Category.CategoryV1) -> Bool {
  if (lhs === rhs) {
    return true
  }
...
public extension Services.Feed.Containers.Category {
  public struct CategoryRoot {
    public static var sharedInstance : CategoryRoot {
     struct Static {
  ...
  final public class CategoryV1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public private(set) var types:Services.Feed.Containers.Category.CategoryV1.CategoryTypeV1 = Services.Feed.Containers.Category.CategoryV1.CategoryTypeV1.DirectReports
    ...
    public class func parseFromData(data:NSData) -> Services.Feed.Containers.Category.CategoryV1 {
    ...
    public class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) -> Services.Feed.Containers.Category.CategoryV1 {
      return Services.Feed.Containers.Category.CategoryV1.builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(input:NSInputStream) -> Services.Feed.Containers.Category.CategoryV1 {
      return Services.Feed.Containers.Category.CategoryV1.builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) ->Services.Feed.Containers.Category.CategoryV1 {
    ...
    public class func parseFromCodedInputStream(input:CodedInputStream) -> Services.Feed.Containers.Category.CategoryV1 {
      return Services.Feed.Containers.Category.CategoryV1.builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Feed.Containers.Category.CategoryV1 {
    ...
    public class func builder() -> Services.Feed.Containers.Category.CategoryV1Builder {
      return Services.Feed.Containers.Category.CategoryV1.classBuilder() as! Services.Feed.Containers.Category.CategoryV1Builder
    }
    public func builder() -> Services.Feed.Containers.Category.CategoryV1Builder {
    ...
    public func toBuilder() -> Services.Feed.Containers.Category.CategoryV1Builder {
      return Services.Feed.Containers.Category.CategoryV1.builderWithPrototype(self)
    }
    public class func builderWithPrototype(prototype:Services.Feed.Containers.Category.CategoryV1) -> Services.Feed.Containers.Category.CategoryV1Builder {
  ...
  final public class CategoryV1Builder : GeneratedMessageBuilder {
    ...
    public func setVersion(value:UInt32)-> Services.Feed.Containers.Category.CategoryV1Builder {
      self.version = value
      return self
    }
    public func clearVersion() -> Services.Feed.Containers.Category.CategoryV1Builder{
    ...
    public func setTitle(value:String)-> Services.Feed.Containers.Category.CategoryV1Builder {
      self.title = value
      return self
    }
    public func clearTitle() -> Services.Feed.Containers.Category.CategoryV1Builder{
    ...
    public func setContentKey(value:String)-> Services.Feed.Containers.Category.CategoryV1Builder {
      self.contentKey = value
      return self
    }
    public func clearContentKey() -> Services.Feed.Containers.Category.CategoryV1Builder{
      ...
      public var types:Services.Feed.Containers.Category.CategoryV1.CategoryTypeV1 {
          get {
      ...
      public func setTypes(value:Services.Feed.Containers.Category.CategoryV1.CategoryTypeV1)-> Services.Feed.Containers.Category.CategoryV1Builder {
        self.types = value
        return self
      }
      public func clearTypes() -> Services.Feed.Containers.Category.CategoryV1Builder {
    ...
    public func setTotalCount(value:UInt32)-> Services.Feed.Containers.Category.CategoryV1Builder {
      self.totalCount = value
      return self
    }
    public func clearTotalCount() -> Services.Feed.Containers.Category.CategoryV1Builder{
    ...
    public func setProfiles(value:Array<Services.Profile.Containers.Profile.ProfileV1>)-> Services.Feed.Containers.Category.CategoryV1Builder {
      self.profiles = value
      return self
    }
    public func clearProfiles() -> Services.Feed.Containers.Category.CategoryV1Builder {
    ...
    public func setAddresses(value:Array<Services.Organization.Containers.Address.AddressV1>)-> Services.Feed.Containers.Category.CategoryV1Builder {
      self.addresses = value
      return self
    }
    public func clearAddresses() -> Services.Feed.Containers.Category.CategoryV1Builder {
    ...
    public func setTags(value:Array<Services.Profile.Containers.Tag.TagV1>)-> Services.Feed.Containers.Category.CategoryV1Builder {
      self.tags = value
      return self
    }
    public func clearTags() -> Services.Feed.Containers.Category.CategoryV1Builder {
    ...
    public func setTeams(value:Array<Services.Organization.Containers.Team.TeamV1>)-> Services.Feed.Containers.Category.CategoryV1Builder {
      self.teams = value
      return self
    }
    public func clearTeams() -> Services.Feed.Containers.Category.CategoryV1Builder {
    ...
    public func setNotes(value:Array<Services.Note.Containers.Note.NoteV1>)-> Services.Feed.Containers.Category.CategoryV1Builder {
      self.notes = value
      return self
    }
    public func clearNotes() -> Services.Feed.Containers.Category.CategoryV1Builder {
    ...
    public func setLocations(value:Array<Services.Organization.Containers.Location.LocationV1>)-> Services.Feed.Containers.Category.CategoryV1Builder {
      self.locations = value
      return self
    }
    public func clearLocations() -> Services.Feed.Containers.Category.CategoryV1Builder {
    ...
    public override func clear() -> Services.Feed.Containers.Category.CategoryV1Builder {
      builderResult = Services.Feed.Containers.Category.CategoryV1()
      return self
    }
    public override func clone() -> Services.Feed.Containers.Category.CategoryV1Builder {
      return Services.Feed.Containers.Category.CategoryV1.builderWithPrototype(builderResult)
    }
    public override func build() -> Services.Feed.Containers.Category.CategoryV1 {
         checkInitialized()
         return buildPartial()
    }
    public func buildPartial() -> Services.Feed.Containers.Category.CategoryV1 {
      var returnMe:Services.Feed.Containers.Category.CategoryV1 = builderResult
      return returnMe
    }
    public func mergeFrom(other:Services.Feed.Containers.Category.CategoryV1) -> Services.Feed.Containers.Category.CategoryV1Builder {
    ...
    public override func mergeFromCodedInputStream(input:CodedInputStream) ->Services.Feed.Containers.Category.CategoryV1Builder {
         return mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
    }
    public override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Feed.Containers.Category.CategoryV1Builder {
