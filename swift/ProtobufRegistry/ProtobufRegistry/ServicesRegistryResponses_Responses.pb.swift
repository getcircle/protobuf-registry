...
public var ServicesRegistryResponsesOrganizationgetAuthenticationInstructions:ConcreateExtensionField {
   get {
       return Services.Registry.Responses.ResponsesRoot.sharedInstance.ServicesRegistryResponsesOrganizationgetAuthenticationInstructionsStatic
   }
}
...
public extension Services.Registry.Responses {
  public struct ResponsesRoot {
    ...
    var ServicesRegistryResponsesOrganizationgetAuthenticationInstructionsStatic:ConcreateExtensionField
    ...
    init() {
      ...
      ServicesRegistryResponsesOrganizationgetAuthenticationInstructionsStatic = ConcreateExtensionField(type:ExtensionType.ExtensionTypeMessage, extendedClass:Soa.ActionResultV1.self, fieldNumber: 222, defaultValue:Services.Organization.Actions.GetAuthenticationInstructions.ResponseV1(), messageOrGroupClass:Services.Organization.Actions.GetAuthenticationInstructions.ResponseV1.self, isRepeated:false, isPacked:false, isMessageSetWireFormat:false)
    ...
    public func registerAllExtensions(registry:ExtensionRegistry) {
      ...
      registry.addExtension(ServicesRegistryResponsesOrganizationgetAuthenticationInstructionsStatic)
  ...
  final public class Organization : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func getAuthenticationInstructions() -> ConcreateExtensionField {
         return ServicesRegistryResponsesOrganizationgetAuthenticationInstructions
    }
    required public init() {
         super.init()
    }
  ...
  final public class History : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) -> Services.Registry.Responses.History {
      return Services.Registry.Responses.History.builder().mergeFromData(data, extensionRegistry:Services.Registry.Responses.ResponsesRoot.sharedInstance.extensionRegistry).build()
    }
    public class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) -> Services.Registry.Responses.History {
      return Services.Registry.Responses.History.builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(input:NSInputStream) -> Services.Registry.Responses.History {
      return Services.Registry.Responses.History.builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) ->Services.Registry.Responses.History {
      return Services.Registry.Responses.History.builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream) -> Services.Registry.Responses.History {
      return Services.Registry.Responses.History.builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Registry.Responses.History {
      return Services.Registry.Responses.History.builder().mergeFromCodedInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func builder() -> Services.Registry.Responses.HistoryBuilder {
      return Services.Registry.Responses.History.classBuilder() as! Services.Registry.Responses.HistoryBuilder
    }
    public func builder() -> Services.Registry.Responses.HistoryBuilder {
      return classBuilder() as! Services.Registry.Responses.HistoryBuilder
    }
    public override class func classBuilder() -> MessageBuilder {
      return Services.Registry.Responses.HistoryBuilder()
    }
    public override func classBuilder() -> MessageBuilder {
      return Services.Registry.Responses.History.builder()
    }
    public func toBuilder() -> Services.Registry.Responses.HistoryBuilder {
      return Services.Registry.Responses.History.builderWithPrototype(self)
    }
    public class func builderWithPrototype(prototype:Services.Registry.Responses.History) -> Services.Registry.Responses.HistoryBuilder {
      return Services.Registry.Responses.History.builder().mergeFrom(prototype)
    }
    override public func writeDescriptionTo(inout output:String, indent:String) {
      unknownFields.writeDescriptionTo(&output, indent:indent)
    }
  ...
  final public class HistoryBuilder : GeneratedMessageBuilder {
    private var builderResult:Services.Registry.Responses.History
    ...
    public override func clear() -> Services.Registry.Responses.HistoryBuilder {
      builderResult = Services.Registry.Responses.History()
      return self
    }
    public override func clone() -> Services.Registry.Responses.HistoryBuilder {
      return Services.Registry.Responses.History.builderWithPrototype(builderResult)
    }
    public override func build() -> Services.Registry.Responses.History {
         checkInitialized()
         return buildPartial()
    }
    public func buildPartial() -> Services.Registry.Responses.History {
      var returnMe:Services.Registry.Responses.History = builderResult
      return returnMe
    }
    public func mergeFrom(other:Services.Registry.Responses.History) -> Services.Registry.Responses.HistoryBuilder {
    ...
    public override func mergeFromCodedInputStream(input:CodedInputStream) ->Services.Registry.Responses.HistoryBuilder {
         return mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
    }
    public override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Registry.Responses.HistoryBuilder {
      var unknownFieldsBuilder:UnknownFieldSetBuilder = UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
      while (true) {
        var tag = input.readTag()
        switch tag {
  ...
  final public class Payment : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) -> Services.Registry.Responses.Payment {
      return Services.Registry.Responses.Payment.builder().mergeFromData(data, extensionRegistry:Services.Registry.Responses.ResponsesRoot.sharedInstance.extensionRegistry).build()
    }
    public class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) -> Services.Registry.Responses.Payment {
      return Services.Registry.Responses.Payment.builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(input:NSInputStream) -> Services.Registry.Responses.Payment {
      return Services.Registry.Responses.Payment.builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) ->Services.Registry.Responses.Payment {
      return Services.Registry.Responses.Payment.builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream) -> Services.Registry.Responses.Payment {
      return Services.Registry.Responses.Payment.builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Registry.Responses.Payment {
      return Services.Registry.Responses.Payment.builder().mergeFromCodedInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func builder() -> Services.Registry.Responses.PaymentBuilder {
      return Services.Registry.Responses.Payment.classBuilder() as! Services.Registry.Responses.PaymentBuilder
    }
    public func builder() -> Services.Registry.Responses.PaymentBuilder {
      return classBuilder() as! Services.Registry.Responses.PaymentBuilder
    }
    public override class func classBuilder() -> MessageBuilder {
      return Services.Registry.Responses.PaymentBuilder()
    }
    public override func classBuilder() -> MessageBuilder {
      return Services.Registry.Responses.Payment.builder()
    }
    public func toBuilder() -> Services.Registry.Responses.PaymentBuilder {
      return Services.Registry.Responses.Payment.builderWithPrototype(self)
    }
    public class func builderWithPrototype(prototype:Services.Registry.Responses.Payment) -> Services.Registry.Responses.PaymentBuilder {
      return Services.Registry.Responses.Payment.builder().mergeFrom(prototype)
    }
    override public func writeDescriptionTo(inout output:String, indent:String) {
      unknownFields.writeDescriptionTo(&output, indent:indent)
    }
  ...
  final public class PaymentBuilder : GeneratedMessageBuilder {
    private var builderResult:Services.Registry.Responses.Payment
    ...
    public override func clear() -> Services.Registry.Responses.PaymentBuilder {
      builderResult = Services.Registry.Responses.Payment()
      return self
    }
    public override func clone() -> Services.Registry.Responses.PaymentBuilder {
      return Services.Registry.Responses.Payment.builderWithPrototype(builderResult)
    }
    public override func build() -> Services.Registry.Responses.Payment {
         checkInitialized()
         return buildPartial()
    }
    public func buildPartial() -> Services.Registry.Responses.Payment {
      var returnMe:Services.Registry.Responses.Payment = builderResult
      return returnMe
    }
    public func mergeFrom(other:Services.Registry.Responses.Payment) -> Services.Registry.Responses.PaymentBuilder {
    ...
    public override func mergeFromCodedInputStream(input:CodedInputStream) ->Services.Registry.Responses.PaymentBuilder {
         return mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
    }
    public override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Registry.Responses.PaymentBuilder {
      var unknownFieldsBuilder:UnknownFieldSetBuilder = UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
      while (true) {
        var tag = input.readTag()
        switch tag {
