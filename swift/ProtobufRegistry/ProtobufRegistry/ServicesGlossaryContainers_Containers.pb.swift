...
public extension Services.Glossary.Containers {
  ...
  final public class TermV1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    override public func writeToCodedOutputStream(output:CodedOutputStream) {
      ...
      if hasCreatedByProfileId {
        output.writeString(6, value:createdByProfileId)
      }
      if hasCreated {
  ...
  final public class TermV1Builder : GeneratedMessageBuilder {
    ...
    public func setCreatedByProfileId(value:String)-> Services.Glossary.Containers.TermV1Builder {
      self.createdByProfileId = value
      return self
    }
    public func clearCreatedByProfileId() -> Services.Glossary.Containers.TermV1Builder{
    ...
    public override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Glossary.Containers.TermV1Builder {
      ...
      while (true) {
        ...
        case 50 :
          createdByProfileId = input.readString()
