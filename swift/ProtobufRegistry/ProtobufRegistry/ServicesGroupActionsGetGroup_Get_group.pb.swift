...
public extension Services.Group.Actions.GetGroup {
  ...
  final public class RequestV1Builder : GeneratedMessageBuilder {
    ...
    public func setGroupKey(value:String)-> Services.Group.Actions.GetGroup.RequestV1Builder {
      self.groupKey = value
      return self
    }
    public func clearGroupKey() -> Services.Group.Actions.GetGroup.RequestV1Builder{
