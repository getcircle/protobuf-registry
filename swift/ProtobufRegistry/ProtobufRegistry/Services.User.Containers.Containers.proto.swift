...
public extension Services.User.Containers {
  ...
  final public class AccessRequestV1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(input:NSInputStream) throws -> Array<Services.User.Containers.AccessRequestV1> {
      var mergedArray = Array<Services.User.Containers.AccessRequestV1>()
      while let value = try parseFromDelimitedFromInputStream(input) {
        mergedArray += [value]
      }
      return mergedArray
    }
    public class func parseFromDelimitedFromInputStream(input:NSInputStream) throws -> Services.User.Containers.AccessRequestV1? {
      return try Services.User.Containers.AccessRequestV1.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(data:NSData) throws -> Services.User.Containers.AccessRequestV1 {
      return try Services.User.Containers.AccessRequestV1.Builder().mergeFromData(data, extensionRegistry:Services.User.Containers.ContainersRoot.sharedInstance.extensionRegistry).build()
    }
    public class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) throws -> Services.User.Containers.AccessRequestV1 {
      return try Services.User.Containers.AccessRequestV1.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(input:NSInputStream) throws -> Services.User.Containers.AccessRequestV1 {
      return try Services.User.Containers.AccessRequestV1.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) throws -> Services.User.Containers.AccessRequestV1 {
      return try Services.User.Containers.AccessRequestV1.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream) throws -> Services.User.Containers.AccessRequestV1 {
      return try Services.User.Containers.AccessRequestV1.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Services.User.Containers.AccessRequestV1 {
      return try Services.User.Containers.AccessRequestV1.Builder().mergeFromCodedInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func getBuilder() -> Services.User.Containers.AccessRequestV1.Builder {
      return Services.User.Containers.AccessRequestV1.classBuilder() as! Services.User.Containers.AccessRequestV1.Builder
    }
    public func getBuilder() -> Services.User.Containers.AccessRequestV1.Builder {
      return classBuilder() as! Services.User.Containers.AccessRequestV1.Builder
    }
    ...
    public func toBuilder() throws -> Services.User.Containers.AccessRequestV1.Builder {
      return try Services.User.Containers.AccessRequestV1.builderWithPrototype(self)
    }
    public class func builderWithPrototype(prototype:Services.User.Containers.AccessRequestV1) throws -> Services.User.Containers.AccessRequestV1.Builder {
      return try Services.User.Containers.AccessRequestV1.Builder().mergeFrom(prototype)
    }
    ...
    final public class Builder : GeneratedMessageBuilder {
      private var builderResult:Services.User.Containers.AccessRequestV1 = Services.User.Containers.AccessRequestV1()
      public func getMessage() -> Services.User.Containers.AccessRequestV1 {
      ...
      public func setVersion(value:UInt32) -> Services.User.Containers.AccessRequestV1.Builder {
        self.version = value
        return self
      }
      public func clearVersion() -> Services.User.Containers.AccessRequestV1.Builder{
      ...
      public func setId(value:String) -> Services.User.Containers.AccessRequestV1.Builder {
        self.id = value
        return self
      }
      public func clearId() -> Services.User.Containers.AccessRequestV1.Builder{
      ...
      public func setUserId(value:String) -> Services.User.Containers.AccessRequestV1.Builder {
        self.userId = value
        return self
      }
      public func clearUserId() -> Services.User.Containers.AccessRequestV1.Builder{
      ...
      public override func clear() -> Services.User.Containers.AccessRequestV1.Builder {
        builderResult = Services.User.Containers.AccessRequestV1()
        return self
      }
      public override func clone() throws -> Services.User.Containers.AccessRequestV1.Builder {
        return try Services.User.Containers.AccessRequestV1.builderWithPrototype(builderResult)
      }
      public override func build() throws -> Services.User.Containers.AccessRequestV1 {
           try checkInitialized()
           return buildPartial()
      }
      public func buildPartial() -> Services.User.Containers.AccessRequestV1 {
        let returnMe:Services.User.Containers.AccessRequestV1 = builderResult
        return returnMe
      }
      public func mergeFrom(other:Services.User.Containers.AccessRequestV1) throws -> Services.User.Containers.AccessRequestV1.Builder {
      ...
      public override func mergeFromCodedInputStream(input:CodedInputStream) throws -> Services.User.Containers.AccessRequestV1.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      public override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Services.User.Containers.AccessRequestV1.Builder {
