...
public var GoogleProtobufSwiftDescriptorRootswiftFileOptions:ConcreateExtensionField {
   get {
       return Google.Protobuf.SwiftDescriptorRoot.sharedInstance.GoogleProtobufSwiftDescriptorRootswiftFileOptionsStatic
   }
}
public extension Google.Protobuf {
  public struct SwiftDescriptorRoot {
    ...
    var GoogleProtobufSwiftDescriptorRootswiftFileOptionsStatic:ConcreateExtensionField
    public var extensionRegistry:ExtensionRegistry

    init() {
      GoogleProtobufSwiftDescriptorRootswiftFileOptionsStatic = ConcreateExtensionField(type:ExtensionType.ExtensionTypeMessage, extendedClass:Google.Protobuf.FileOptions.self, fieldNumber: 5092014, defaultValue:Google.Protobuf.SwiftFileOptions(), messageOrGroupClass:Google.Protobuf.SwiftFileOptions.self, isRepeated:false, isPacked:false, isMessageSetWireFormat:false)
      extensionRegistry = ExtensionRegistry()
      registerAllExtensions(extensionRegistry)
      Google.Protobuf.DescriptorRoot.sharedInstance.registerAllExtensions(extensionRegistry)
    }
    public func registerAllExtensions(registry:ExtensionRegistry) {
      registry.addExtension(GoogleProtobufSwiftDescriptorRootswiftFileOptionsStatic)
    }
    public static func swiftFileOptions() -> ConcreateExtensionField {
         return SwiftDescriptorRoot.sharedInstance.GoogleProtobufSwiftDescriptorRootswiftFileOptionsStatic
    }
  }
  ...
  final public class SwiftFileOptions : GeneratedMessage, GeneratedMessageProtocol {
    override public subscript(key: String) -> Any? {
           ...
           case "compileForFramework": return compileForFramework
           default: return nil
           }
    }
