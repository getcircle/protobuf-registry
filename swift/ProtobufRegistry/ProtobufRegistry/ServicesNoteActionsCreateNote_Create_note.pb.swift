...
import Foundation
public extension Services{ public struct Note { public struct Actions { public struct CreateNote { }}}}

public func == (lhs: Services.Note.Actions.CreateNote.RequestV1, rhs: Services.Note.Actions.CreateNote.RequestV1) -> Bool {
  if (lhs === rhs) {
    return true
  }
...
public func == (lhs: Services.Note.Actions.CreateNote.ResponseV1, rhs: Services.Note.Actions.CreateNote.ResponseV1) -> Bool {
  if (lhs === rhs) {
    return true
  }
  var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
...
public extension Services.Note.Actions.CreateNote {
  public struct CreateNoteRoot {
    public static var sharedInstance : CreateNoteRoot {
     struct Static {
  ...
  final public class RequestV1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) -> Services.Note.Actions.CreateNote.RequestV1 {
    ...
    public class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) -> Services.Note.Actions.CreateNote.RequestV1 {
      return Services.Note.Actions.CreateNote.RequestV1.builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(input:NSInputStream) -> Services.Note.Actions.CreateNote.RequestV1 {
      return Services.Note.Actions.CreateNote.RequestV1.builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) ->Services.Note.Actions.CreateNote.RequestV1 {
    ...
    public class func parseFromCodedInputStream(input:CodedInputStream) -> Services.Note.Actions.CreateNote.RequestV1 {
      return Services.Note.Actions.CreateNote.RequestV1.builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Note.Actions.CreateNote.RequestV1 {
    ...
    public class func builder() -> Services.Note.Actions.CreateNote.RequestV1Builder {
      return Services.Note.Actions.CreateNote.RequestV1.classBuilder() as! Services.Note.Actions.CreateNote.RequestV1Builder
    }
    public func builder() -> Services.Note.Actions.CreateNote.RequestV1Builder {
    ...
    public func toBuilder() -> Services.Note.Actions.CreateNote.RequestV1Builder {
      return Services.Note.Actions.CreateNote.RequestV1.builderWithPrototype(self)
    }
    public class func builderWithPrototype(prototype:Services.Note.Actions.CreateNote.RequestV1) -> Services.Note.Actions.CreateNote.RequestV1Builder {
  ...
  final public class RequestV1Builder : GeneratedMessageBuilder {
    ...
    public func setVersion(value:UInt32)-> Services.Note.Actions.CreateNote.RequestV1Builder {
      self.version = value
      return self
    }
    public func clearVersion() -> Services.Note.Actions.CreateNote.RequestV1Builder{
    ...
    public func clearNote() -> Services.Note.Actions.CreateNote.RequestV1Builder {
    ...
    public override func clear() -> Services.Note.Actions.CreateNote.RequestV1Builder {
      builderResult = Services.Note.Actions.CreateNote.RequestV1()
      return self
    }
    public override func clone() -> Services.Note.Actions.CreateNote.RequestV1Builder {
      return Services.Note.Actions.CreateNote.RequestV1.builderWithPrototype(builderResult)
    }
    public override func build() -> Services.Note.Actions.CreateNote.RequestV1 {
         checkInitialized()
         return buildPartial()
    }
    public func buildPartial() -> Services.Note.Actions.CreateNote.RequestV1 {
      var returnMe:Services.Note.Actions.CreateNote.RequestV1 = builderResult
      return returnMe
    }
    public func mergeFrom(other:Services.Note.Actions.CreateNote.RequestV1) -> Services.Note.Actions.CreateNote.RequestV1Builder {
    ...
    public override func mergeFromCodedInputStream(input:CodedInputStream) ->Services.Note.Actions.CreateNote.RequestV1Builder {
         return mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
    }
    public override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Note.Actions.CreateNote.RequestV1Builder {
  ...
  final public class ResponseV1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseFromData(data:NSData) -> Services.Note.Actions.CreateNote.ResponseV1 {
    ...
    public class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) -> Services.Note.Actions.CreateNote.ResponseV1 {
      return Services.Note.Actions.CreateNote.ResponseV1.builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(input:NSInputStream) -> Services.Note.Actions.CreateNote.ResponseV1 {
      return Services.Note.Actions.CreateNote.ResponseV1.builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) ->Services.Note.Actions.CreateNote.ResponseV1 {
    ...
    public class func parseFromCodedInputStream(input:CodedInputStream) -> Services.Note.Actions.CreateNote.ResponseV1 {
      return Services.Note.Actions.CreateNote.ResponseV1.builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Note.Actions.CreateNote.ResponseV1 {
    ...
    public class func builder() -> Services.Note.Actions.CreateNote.ResponseV1Builder {
      return Services.Note.Actions.CreateNote.ResponseV1.classBuilder() as! Services.Note.Actions.CreateNote.ResponseV1Builder
    }
    public func builder() -> Services.Note.Actions.CreateNote.ResponseV1Builder {
    ...
    public func toBuilder() -> Services.Note.Actions.CreateNote.ResponseV1Builder {
      return Services.Note.Actions.CreateNote.ResponseV1.builderWithPrototype(self)
    }
    public class func builderWithPrototype(prototype:Services.Note.Actions.CreateNote.ResponseV1) -> Services.Note.Actions.CreateNote.ResponseV1Builder {
  ...
  final public class ResponseV1Builder : GeneratedMessageBuilder {
    ...
    public func setVersion(value:UInt32)-> Services.Note.Actions.CreateNote.ResponseV1Builder {
      self.version = value
      return self
    }
    public func clearVersion() -> Services.Note.Actions.CreateNote.ResponseV1Builder{
         builderResult.hasVersion = false
         builderResult.version = UInt32(1)
         return self
    }
    ...
    public func clearNote() -> Services.Note.Actions.CreateNote.ResponseV1Builder {
      builderResult.hasNote = false
      builderResult.note = nil
      return self
    }
    ...
    public override func clear() -> Services.Note.Actions.CreateNote.ResponseV1Builder {
      builderResult = Services.Note.Actions.CreateNote.ResponseV1()
      return self
    }
    public override func clone() -> Services.Note.Actions.CreateNote.ResponseV1Builder {
      return Services.Note.Actions.CreateNote.ResponseV1.builderWithPrototype(builderResult)
    }
    public override func build() -> Services.Note.Actions.CreateNote.ResponseV1 {
         checkInitialized()
         return buildPartial()
    }
    public func buildPartial() -> Services.Note.Actions.CreateNote.ResponseV1 {
      var returnMe:Services.Note.Actions.CreateNote.ResponseV1 = builderResult
      return returnMe
    }
    public func mergeFrom(other:Services.Note.Actions.CreateNote.ResponseV1) -> Services.Note.Actions.CreateNote.ResponseV1Builder {
    ...
    public override func mergeFromCodedInputStream(input:CodedInputStream) ->Services.Note.Actions.CreateNote.ResponseV1Builder {
         return mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
    }
    public override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Note.Actions.CreateNote.ResponseV1Builder {
      var unknownFieldsBuilder:UnknownFieldSetBuilder = UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
      while (true) {
        var tag = input.readTag()
        switch tag {
