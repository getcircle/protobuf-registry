...
public extension Services.Organization.Actions.GetOrganization {
  ...
  final public class ResponseV1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    final public class Builder : GeneratedMessageBuilder {
      ...
      public func setInflations(value:Services.Common.Containers.InflationsV1!) -> Services.Organization.Actions.GetOrganization.ResponseV1.Builder {
        self.inflations = value
        return self
      }
      public func mergeInflations(value:Services.Common.Containers.InflationsV1) throws -> Services.Organization.Actions.GetOrganization.ResponseV1.Builder {
      ...
      public func clearInflations() -> Services.Organization.Actions.GetOrganization.ResponseV1.Builder {
      ...
      public func setFields(value:Services.Common.Containers.FieldsV1!) -> Services.Organization.Actions.GetOrganization.ResponseV1.Builder {
        self.fields = value
        return self
      }
      public func mergeFields(value:Services.Common.Containers.FieldsV1) throws -> Services.Organization.Actions.GetOrganization.ResponseV1.Builder {
      ...
      public func clearFields() -> Services.Organization.Actions.GetOrganization.ResponseV1.Builder {
        fieldsBuilder_ = nil
