...
internal extension Services.Organization.Containers{ internal struct Color { }}

internal func == (lhs: Services.Organization.Containers.Color.ColorV1, rhs: Services.Organization.Containers.Color.ColorV1) -> Bool {
  if (lhs === rhs) {
    return true
  }
...
internal extension Services.Organization.Containers.Color {
  internal struct ColorRoot {
    internal static var sharedInstance : ColorRoot {
     struct Static {
  ...
  final internal class ColorV1 : GeneratedMessage, GeneratedMessageProtocol {
    private(set) var hasVersion:Bool = false
    private(set) var version:UInt32 = UInt32(0)

    private(set) var hasRed:Bool = false
    private(set) var red:UInt32 = UInt32(0)

    private(set) var hasGreen:Bool = false
    private(set) var green:UInt32 = UInt32(0)

    private(set) var hasBlue:Bool = false
    private(set) var blue:UInt32 = UInt32(0)
    ...
    internal class func parseFromData(data:NSData) -> Services.Organization.Containers.Color.ColorV1 {
    ...
    internal class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) -> Services.Organization.Containers.Color.ColorV1 {
    ...
    internal class func parseFromInputStream(input:NSInputStream) -> Services.Organization.Containers.Color.ColorV1 {
      return Services.Organization.Containers.Color.ColorV1.builder().mergeFromInputStream(input).build()
    }
    internal class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) ->Services.Organization.Containers.Color.ColorV1 {
    ...
    internal class func parseFromCodedInputStream(input:CodedInputStream) -> Services.Organization.Containers.Color.ColorV1 {
      return Services.Organization.Containers.Color.ColorV1.builder().mergeFromCodedInputStream(input).build()
    }
    internal class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Organization.Containers.Color.ColorV1 {
    ...
    internal class func builder() -> Services.Organization.Containers.Color.ColorV1Builder {
    ...
    internal func builder() -> Services.Organization.Containers.Color.ColorV1Builder {
    ...
    internal func toBuilder() -> Services.Organization.Containers.Color.ColorV1Builder {
      return Services.Organization.Containers.Color.ColorV1.builderWithPrototype(self)
    }
    internal class func builderWithPrototype(prototype:Services.Organization.Containers.Color.ColorV1) -> Services.Organization.Containers.Color.ColorV1Builder {
  ...
  final internal class ColorV1Builder : GeneratedMessageBuilder {
    ...
    func setVersion(value:UInt32)-> Services.Organization.Containers.Color.ColorV1Builder {
      self.version = value
      return self
    }
    internal func clearVersion() -> Services.Organization.Containers.Color.ColorV1Builder{
    ...
    func setRed(value:UInt32)-> Services.Organization.Containers.Color.ColorV1Builder {
      self.red = value
      return self
    }
    internal func clearRed() -> Services.Organization.Containers.Color.ColorV1Builder{
    ...
    func setGreen(value:UInt32)-> Services.Organization.Containers.Color.ColorV1Builder {
      self.green = value
      return self
    }
    internal func clearGreen() -> Services.Organization.Containers.Color.ColorV1Builder{
    ...
    func setBlue(value:UInt32)-> Services.Organization.Containers.Color.ColorV1Builder {
      self.blue = value
      return self
    }
    internal func clearBlue() -> Services.Organization.Containers.Color.ColorV1Builder{
    ...
    internal override func clear() -> Services.Organization.Containers.Color.ColorV1Builder {
      builderResult = Services.Organization.Containers.Color.ColorV1()
      return self
    }
    internal override func clone() -> Services.Organization.Containers.Color.ColorV1Builder {
      return Services.Organization.Containers.Color.ColorV1.builderWithPrototype(builderResult)
    }
    internal override func build() -> Services.Organization.Containers.Color.ColorV1 {
         checkInitialized()
         return buildPartial()
    }
    internal func buildPartial() -> Services.Organization.Containers.Color.ColorV1 {
      var returnMe:Services.Organization.Containers.Color.ColorV1 = builderResult
      return returnMe
    }
    internal func mergeFrom(other:Services.Organization.Containers.Color.ColorV1) -> Services.Organization.Containers.Color.ColorV1Builder {
    ...
    internal override func mergeFromCodedInputStream(input:CodedInputStream) ->Services.Organization.Containers.Color.ColorV1Builder {
         return mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
    }
    internal override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Organization.Containers.Color.ColorV1Builder {
