...
public extension Services.Registry.Responses {
  public struct ResponsesRoot {
    ...
    init() {
      ...
      ServicesRegistryResponsesSearchsearchV2Static = ConcreateExtensionField(type:ExtensionType.ExtensionTypeMessage, extendedClass:Soa.ActionResultV1.self, fieldNumber: 401, defaultValue:Services.Search.Actions.Search.ResponseV2(), messageOrGroupClass:Services.Search.Actions.Search.ResponseV2.self, isRepeated:false, isPacked:false, isMessageSetWireFormat:false)
