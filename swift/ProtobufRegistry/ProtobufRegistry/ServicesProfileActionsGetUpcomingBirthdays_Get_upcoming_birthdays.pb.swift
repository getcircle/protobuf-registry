...
internal extension Services.Profile.Actions{ internal struct GetUpcomingBirthdays { }}

internal func == (lhs: Services.Profile.Actions.GetUpcomingBirthdays.RequestV1, rhs: Services.Profile.Actions.GetUpcomingBirthdays.RequestV1) -> Bool {
  if (lhs === rhs) {
    return true
  }
...
internal func == (lhs: Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1, rhs: Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1) -> Bool {
  if (lhs === rhs) {
    return true
  }
  var fieldCheck:Bool = (lhs.hashValue == rhs.hashValue)
...
internal extension Services.Profile.Actions.GetUpcomingBirthdays {
  internal struct GetUpcomingBirthdaysRoot {
    internal static var sharedInstance : GetUpcomingBirthdaysRoot {
     struct Static {
  ...
  final internal class RequestV1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1 {
    ...
    internal class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1 {
    ...
    internal class func parseFromInputStream(input:NSInputStream) -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1 {
      return Services.Profile.Actions.GetUpcomingBirthdays.RequestV1.builder().mergeFromInputStream(input).build()
    }
    internal class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) ->Services.Profile.Actions.GetUpcomingBirthdays.RequestV1 {
    ...
    internal class func parseFromCodedInputStream(input:CodedInputStream) -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1 {
      return Services.Profile.Actions.GetUpcomingBirthdays.RequestV1.builder().mergeFromCodedInputStream(input).build()
    }
    internal class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1 {
    ...
    internal class func builder() -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
    ...
    internal func builder() -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
    ...
    internal func toBuilder() -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
      return Services.Profile.Actions.GetUpcomingBirthdays.RequestV1.builderWithPrototype(self)
    }
    internal class func builderWithPrototype(prototype:Services.Profile.Actions.GetUpcomingBirthdays.RequestV1) -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
  ...
  final internal class RequestV1Builder : GeneratedMessageBuilder {
    ...
    func setVersion(value:UInt32)-> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
      self.version = value
      return self
    }
    internal func clearVersion() -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder{
    ...
    func setOrganizationId(value:String)-> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
      self.organizationId = value
      return self
    }
    internal func clearOrganizationId() -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder{
    ...
    internal override func clear() -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
      builderResult = Services.Profile.Actions.GetUpcomingBirthdays.RequestV1()
      return self
    }
    internal override func clone() -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
      return Services.Profile.Actions.GetUpcomingBirthdays.RequestV1.builderWithPrototype(builderResult)
    }
    internal override func build() -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1 {
         checkInitialized()
         return buildPartial()
    }
    internal func buildPartial() -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1 {
      var returnMe:Services.Profile.Actions.GetUpcomingBirthdays.RequestV1 = builderResult
      return returnMe
    }
    internal func mergeFrom(other:Services.Profile.Actions.GetUpcomingBirthdays.RequestV1) -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
    ...
    internal override func mergeFromCodedInputStream(input:CodedInputStream) ->Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
         return mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
    }
    internal override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Profile.Actions.GetUpcomingBirthdays.RequestV1Builder {
  ...
  final internal class ResponseV1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    internal class func parseFromData(data:NSData) -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1 {
    ...
    internal class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1 {
    ...
    internal class func parseFromInputStream(input:NSInputStream) -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1 {
      return Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1.builder().mergeFromInputStream(input).build()
    }
    internal class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) ->Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1 {
    ...
    internal class func parseFromCodedInputStream(input:CodedInputStream) -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1 {
      return Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1.builder().mergeFromCodedInputStream(input).build()
    }
    internal class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1 {
    ...
    internal class func builder() -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
    ...
    internal func builder() -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
    ...
    internal func toBuilder() -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
      return Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1.builderWithPrototype(self)
    }
    internal class func builderWithPrototype(prototype:Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1) -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
  ...
  final internal class ResponseV1Builder : GeneratedMessageBuilder {
    ...
    func setVersion(value:UInt32)-> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
      self.version = value
      return self
    }
    internal func clearVersion() -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder{
         builderResult.hasVersion = false
         builderResult.version = UInt32(1)
         return self
    }
    ...
    func setProfiles(value:Array<Services.Profile.Containers.Profile.ProfileV1>)-> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
      self.profiles = value
      return self
    }
    internal func clearProfiles() -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
    ...
    internal override func clear() -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
      builderResult = Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1()
      return self
    }
    internal override func clone() -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
      return Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1.builderWithPrototype(builderResult)
    }
    internal override func build() -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1 {
         checkInitialized()
         return buildPartial()
    }
    internal func buildPartial() -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1 {
      var returnMe:Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1 = builderResult
      return returnMe
    }
    internal func mergeFrom(other:Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1) -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
    ...
    internal override func mergeFromCodedInputStream(input:CodedInputStream) ->Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
         return mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
    }
    internal override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) -> Services.Profile.Actions.GetUpcomingBirthdays.ResponseV1Builder {
      var unknownFieldsBuilder:UnknownFieldSetBuilder = UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
      while (true) {
        var tag = input.readTag()
        switch tag {
