...
public extension Services.Profile.Actions.CreateProfile {
  ...
  final public class RequestV1Builder : GeneratedMessageBuilder {
    ...
    public func setProfile(value:Services.Profile.Containers.ProfileV1!)-> Services.Profile.Actions.CreateProfile.RequestV1Builder {
      self.profile = value
      return self
    }
    public func mergeProfile(value:Services.Profile.Containers.ProfileV1) -> Services.Profile.Actions.CreateProfile.RequestV1Builder {
  ...
  final public class ResponseV1Builder : GeneratedMessageBuilder {
    ...
    public func setProfile(value:Services.Profile.Containers.ProfileV1!)-> Services.Profile.Actions.CreateProfile.ResponseV1Builder {
      self.profile = value
      return self
    }
    public func mergeProfile(value:Services.Profile.Containers.ProfileV1) -> Services.Profile.Actions.CreateProfile.ResponseV1Builder {
      if (builderResult.hasProfile) {
        builderResult.profile = Services.Profile.Containers.ProfileV1.builderWithPrototype(builderResult.profile).mergeFrom(value).buildPartial()
      } else {
        builderResult.profile = value
