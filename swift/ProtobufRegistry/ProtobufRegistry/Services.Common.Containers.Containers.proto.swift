...
public extension Services.Common.Containers {
  ...
  final public class DescriptionV1 : GeneratedMessage, GeneratedMessageProtocol {
    ...
    public class func parseArrayDelimitedFromInputStream(input:NSInputStream) throws -> Array<Services.Common.Containers.DescriptionV1> {
      var mergedArray = Array<Services.Common.Containers.DescriptionV1>()
      while let value = try parseFromDelimitedFromInputStream(input) {
        mergedArray += [value]
      }
      return mergedArray
    }
    public class func parseFromDelimitedFromInputStream(input:NSInputStream) throws -> Services.Common.Containers.DescriptionV1? {
      return try Services.Common.Containers.DescriptionV1.Builder().mergeDelimitedFromInputStream(input)?.build()
    }
    public class func parseFromData(data:NSData) throws -> Services.Common.Containers.DescriptionV1 {
      return try Services.Common.Containers.DescriptionV1.Builder().mergeFromData(data, extensionRegistry:Services.Common.Containers.ContainersRoot.sharedInstance.extensionRegistry).build()
    }
    public class func parseFromData(data:NSData, extensionRegistry:ExtensionRegistry) throws -> Services.Common.Containers.DescriptionV1 {
      return try Services.Common.Containers.DescriptionV1.Builder().mergeFromData(data, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromInputStream(input:NSInputStream) throws -> Services.Common.Containers.DescriptionV1 {
      return try Services.Common.Containers.DescriptionV1.Builder().mergeFromInputStream(input).build()
    }
    public class func parseFromInputStream(input:NSInputStream, extensionRegistry:ExtensionRegistry) throws -> Services.Common.Containers.DescriptionV1 {
      return try Services.Common.Containers.DescriptionV1.Builder().mergeFromInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream) throws -> Services.Common.Containers.DescriptionV1 {
      return try Services.Common.Containers.DescriptionV1.Builder().mergeFromCodedInputStream(input).build()
    }
    public class func parseFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Services.Common.Containers.DescriptionV1 {
      return try Services.Common.Containers.DescriptionV1.Builder().mergeFromCodedInputStream(input, extensionRegistry:extensionRegistry).build()
    }
    public class func getBuilder() -> Services.Common.Containers.DescriptionV1.Builder {
      return Services.Common.Containers.DescriptionV1.classBuilder() as! Services.Common.Containers.DescriptionV1.Builder
    }
    public func getBuilder() -> Services.Common.Containers.DescriptionV1.Builder {
      return classBuilder() as! Services.Common.Containers.DescriptionV1.Builder
    }
    public override class func classBuilder() -> MessageBuilder {
    ...
    public func toBuilder() throws -> Services.Common.Containers.DescriptionV1.Builder {
      return try Services.Common.Containers.DescriptionV1.builderWithPrototype(self)
    }
    public class func builderWithPrototype(prototype:Services.Common.Containers.DescriptionV1) throws -> Services.Common.Containers.DescriptionV1.Builder {
      return try Services.Common.Containers.DescriptionV1.Builder().mergeFrom(prototype)
    }
    override public func writeDescriptionTo(inout output:String, indent:String) throws {
      if hasVersion {
        output += "\(indent) version: \(version) \n"
    ...
    final public class Builder : GeneratedMessageBuilder {
      private var builderResult:Services.Common.Containers.DescriptionV1 = Services.Common.Containers.DescriptionV1()
      public func getMessage() -> Services.Common.Containers.DescriptionV1 {
          return builderResult
      }
      ...
      public func setVersion(value:UInt32) -> Services.Common.Containers.DescriptionV1.Builder {
        self.version = value
        return self
      }
      public func clearVersion() -> Services.Common.Containers.DescriptionV1.Builder{
           builderResult.hasVersion = false
           builderResult.version = UInt32(1)
           return self
      }
      ...
      public func setValue(value:String) -> Services.Common.Containers.DescriptionV1.Builder {
        self.value = value
        return self
      }
      public func clearValue() -> Services.Common.Containers.DescriptionV1.Builder{
           builderResult.hasValue = false
           builderResult.value = ""
           return self
      }
      ...
      public func setByProfileId(value:String) -> Services.Common.Containers.DescriptionV1.Builder {
        self.byProfileId = value
        return self
      }
      public func clearByProfileId() -> Services.Common.Containers.DescriptionV1.Builder{
      ...
      public func setChanged(value:String) -> Services.Common.Containers.DescriptionV1.Builder {
        self.changed = value
        return self
      }
      public func clearChanged() -> Services.Common.Containers.DescriptionV1.Builder{
      ...
      public func setByProfile(value:Services.Profile.Containers.ProfileV1!) -> Services.Common.Containers.DescriptionV1.Builder {
        self.byProfile = value
        return self
      }
      public func mergeByProfile(value:Services.Profile.Containers.ProfileV1) throws -> Services.Common.Containers.DescriptionV1.Builder {
      ...
      public func clearByProfile() -> Services.Common.Containers.DescriptionV1.Builder {
      ...
      public override func clear() -> Services.Common.Containers.DescriptionV1.Builder {
        builderResult = Services.Common.Containers.DescriptionV1()
        return self
      }
      public override func clone() throws -> Services.Common.Containers.DescriptionV1.Builder {
        return try Services.Common.Containers.DescriptionV1.builderWithPrototype(builderResult)
      }
      public override func build() throws -> Services.Common.Containers.DescriptionV1 {
           try checkInitialized()
           return buildPartial()
      }
      public func buildPartial() -> Services.Common.Containers.DescriptionV1 {
        let returnMe:Services.Common.Containers.DescriptionV1 = builderResult
        return returnMe
      }
      public func mergeFrom(other:Services.Common.Containers.DescriptionV1) throws -> Services.Common.Containers.DescriptionV1.Builder {
      ...
      public override func mergeFromCodedInputStream(input:CodedInputStream) throws -> Services.Common.Containers.DescriptionV1.Builder {
           return try mergeFromCodedInputStream(input, extensionRegistry:ExtensionRegistry())
      }
      public override func mergeFromCodedInputStream(input:CodedInputStream, extensionRegistry:ExtensionRegistry) throws -> Services.Common.Containers.DescriptionV1.Builder {
        let unknownFieldsBuilder:UnknownFieldSet.Builder = try UnknownFieldSet.builderWithUnknownFields(self.unknownFields)
        while (true) {
          let tag = try input.readTag()
          switch tag {
