...
public extension Services.Profile.Containers.Profile {
  ...
  final public class ProfileV1Builder : GeneratedMessageBuilder {
    ...
    public func setCellPhone(value:String)-> Services.Profile.Containers.Profile.ProfileV1Builder {
      self.cellPhone = value
      return self
    }
    public func clearCellPhone() -> Services.Profile.Containers.Profile.ProfileV1Builder{
    ...
    public func setWorkPhone(value:String)-> Services.Profile.Containers.Profile.ProfileV1Builder {
      self.workPhone = value
      return self
    }
    public func clearWorkPhone() -> Services.Profile.Containers.Profile.ProfileV1Builder{
