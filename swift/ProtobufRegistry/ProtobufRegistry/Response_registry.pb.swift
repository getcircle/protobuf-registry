...
public var OrganizationServiceResponses_delete_location:ConcreateExtensionField {
   get {
       return ResponseRegistryRoot.sharedInstance.OrganizationServiceResponses_delete_locationStatic
   }
}
...
public struct ResponseRegistryRoot {
  ...
  var OrganizationServiceResponses_delete_locationStatic:ConcreateExtensionField
  ...
  init() {
    ...
    OrganizationServiceResponses_get_locationStatic = ConcreateExtensionField(type:ExtensionType.ExtensionTypeMessage, extendedClass:ActionResponseResult.self, fieldNumber: 213, defaultValue:OrganizationService.GetLocation.Response(), messageOrGroupClass:OrganizationService.GetLocation.Response.self, isRepeated:false, isPacked:false, isMessageSetWireFormat:false)
    OrganizationServiceResponses_delete_locationStatic = ConcreateExtensionField(type:ExtensionType.ExtensionTypeMessage, extendedClass:ActionResponseResult.self, fieldNumber: 214, defaultValue:OrganizationService.DeleteLocation.Response(), messageOrGroupClass:OrganizationService.DeleteLocation.Response.self, isRepeated:false, isPacked:false, isMessageSetWireFormat:false)
    OrganizationServiceResponses_get_extended_locationStatic = ConcreateExtensionField(type:ExtensionType.ExtensionTypeMessage, extendedClass:ActionResponseResult.self, fieldNumber: 215, defaultValue:OrganizationService.GetExtendedLocation.Response(), messageOrGroupClass:OrganizationService.GetExtendedLocation.Response.self, isRepeated:false, isPacked:false, isMessageSetWireFormat:false)
  ...
  public func registerAllExtensions(registry:ExtensionRegistry) {
    ...
    registry.addExtension(OrganizationServiceResponses_delete_locationStatic)
...
final public class OrganizationServiceResponses : GeneratedMessage {
  ...
  public class func delete_location() -> ConcreateExtensionField {
       return OrganizationServiceResponses_delete_location
  }
