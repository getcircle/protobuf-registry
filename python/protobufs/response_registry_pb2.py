...
_MEDIASERVICERESPONSES = _descriptor.Descriptor(
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='upload_image', full_name='main.responses.MediaServiceResponses.upload_image', index=0,
...
_MEDIASERVICERESPONSES.extensions_by_name['upload_image'].message_type = protobufs.media_service_pb2._MEDIASERVICE_UPLOADIMAGE_RESPONSE
service_protobufs.soa_pb2.ActionResponseResult.RegisterExtension(_MEDIASERVICERESPONSES.extensions_by_name['upload_image'])
