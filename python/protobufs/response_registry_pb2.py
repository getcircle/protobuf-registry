...
_PROFILESERVICERESPONSES = _descriptor.Descriptor(
  ...
  extensions=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_upcoming_aniversaries', full_name='main.responses.ProfileServiceResponses.get_upcoming_aniversaries', index=11,
...
_PROFILESERVICERESPONSES.extensions_by_name['get_upcoming_aniversaries'].message_type = protobufs.profile_service_pb2._PROFILESERVICE_GETUPCOMINGANNIVERSARIES_RESPONSE
service_protobufs.soa_pb2.ActionResponseResult.RegisterExtension(_PROFILESERVICERESPONSES.extensions_by_name['get_upcoming_aniversaries'])
