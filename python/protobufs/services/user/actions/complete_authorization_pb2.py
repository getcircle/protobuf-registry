...
_RESPONSEV1 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='saml_state', full_name='services.user.actions.complete_authorization.ResponseV1.saml_state', index=6,
