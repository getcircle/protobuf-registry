...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto2',
  serialized_pb=b'\n9protobufs/services/organization/actions/set_manager.proto\x12)services.organization.actions.set_manager\x1a\x30protobufs/services/organization/containers.proto\"O\n\tRequestV1\x12\x12\n\x07version\x18\x01 \x01(\r:\x01\x31\x12\x12\n\nprofile_id\x18\x02 \x01(\t\x12\x1a\n\x12manager_profile_id\x18\x03 \x01(\t\"X\n\nResponseV1\x12\x12\n\x07version\x18\x01 \x01(\r:\x01\x31\x12\x36\n\x04team\x18\x02 \x01(\x0b\x32(.services.organization.containers.TeamV1B@\n>com.rhlabs.protobufs.services.organization.actions.set_manager'
  ,
...
_REQUESTV1 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='services.organization.actions.set_manager.RequestV1.version', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='profile_id', full_name='services.organization.actions.set_manager.RequestV1.profile_id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='manager_profile_id', full_name='services.organization.actions.set_manager.RequestV1.manager_profile_id', index=2,
...
_RESPONSEV1 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='services.organization.actions.set_manager.ResponseV1.version', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='team', full_name='services.organization.actions.set_manager.ResponseV1.team', index=1,
