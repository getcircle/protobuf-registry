...
_NOTIFICATIONTOKENV1 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='profile_id', full_name='services.notification.containers.NotificationTokenV1.profile_id', index=6,
