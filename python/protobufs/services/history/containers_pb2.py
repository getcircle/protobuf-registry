...
_ACTIONTYPEV1 = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_TEAM_MEMBER_ROLE', index=2, number=2,
      options=None,
      type=None),
  ],
