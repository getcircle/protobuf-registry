...
# source: protobufs/services/profile/actions/create_profile.proto
...
_REQUESTV1 = _descriptor.Descriptor(
  name='RequestV1',
  full_name='services.profile.actions.create_profile.RequestV1',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='services.profile.actions.create_profile.RequestV1.version', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='profile', full_name='services.profile.actions.create_profile.RequestV1.profile', index=1,
...
_RESPONSEV1 = _descriptor.Descriptor(
  name='ResponseV1',
  full_name='services.profile.actions.create_profile.ResponseV1',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='version', full_name='services.profile.actions.create_profile.ResponseV1.version', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='profile', full_name='services.profile.actions.create_profile.ResponseV1.profile', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
RequestV1 = _reflection.GeneratedProtocolMessageType('RequestV1', (_message.Message,), dict(
  ...
  __module__ = 'protobufs.services.profile.actions.create_profile_pb2'
  # @@protoc_insertion_point(class_scope:services.profile.actions.create_profile.RequestV1)
  ))
...
ResponseV1 = _reflection.GeneratedProtocolMessageType('ResponseV1', (_message.Message,), dict(
  ...
  __module__ = 'protobufs.services.profile.actions.create_profile_pb2'
  # @@protoc_insertion_point(class_scope:services.profile.actions.create_profile.ResponseV1)
  ))
