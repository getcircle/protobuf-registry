...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=b'\n=protobufs/services/profile/actions/bulk_create_profiles.proto\x12-services.profile.actions.bulk_create_profiles\x1a+protobufs/services/profile/containers.proto\"\\\n\tRequestV1\x12\x38\n\x08profiles\x18\x01 \x03(\x0b\x32&.services.profile.containers.ProfileV1\x12\x15\n\rshould_update\x18\x02 \x01(\x08\"F\n\nResponseV1\x12\x38\n\x08profiles\x18\x01 \x03(\x0b\x32&.services.profile.containers.ProfileV1b\x06proto3'
  ,
...
_REQUESTV1 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='profiles', full_name='services.profile.actions.bulk_create_profiles.RequestV1.profiles', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='should_update', full_name='services.profile.actions.bulk_create_profiles.RequestV1.should_update', index=1,
...
_RESPONSEV1 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='profiles', full_name='services.profile.actions.bulk_create_profiles.ResponseV1.profiles', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
