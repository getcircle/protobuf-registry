...
_REQUESTV1 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='user_id', full_name='services.profile.actions.get_profile.RequestV1.user_id', index=2,
