...
_REPORTINGDETAILSV1 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='services.profile.containers.ReportingDetailsV1.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROFILEV1.fields_by_name['contact_methods'].has_options = True
_PROFILEV1.fields_by_name['contact_methods']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), b'\200\265\030\001')
_PROFILEV1.fields_by_name['display_title'].has_options = True
_PROFILEV1.fields_by_name['display_title']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), b'\200\265\030\001')
