...
_POSTV1 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_rich_text', full_name='services.post.containers.PostV1.is_rich_text', index=14,
