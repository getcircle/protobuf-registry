...
_REQUESTV1 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fields', full_name='services.post.actions.get_posts.RequestV1.fields', index=5,
