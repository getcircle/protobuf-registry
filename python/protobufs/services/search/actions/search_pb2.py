...
_REQUESTV1 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='query', full_name='services.search.actions.search.RequestV1.query', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='category', full_name='services.search.actions.search.RequestV1.category', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attribute', full_name='services.search.actions.search.RequestV1.attribute', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attribute_value', full_name='services.search.actions.search.RequestV1.attribute_value', index=3,
...
_RESPONSEV1 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='results', full_name='services.search.actions.search.ResponseV1.results', index=0,
