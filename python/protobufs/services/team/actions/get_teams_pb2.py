...
_REQUESTV1 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='profile_id', full_name='services.team.actions.get_teams.RequestV1.profile_id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='inflations', full_name='services.team.actions.get_teams.RequestV1.inflations', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fields', full_name='services.team.actions.get_teams.RequestV1.fields', index=2,
