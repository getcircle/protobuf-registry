...
_ORGANIZATIONSERVICE_CONTAINERS_ORGANIZATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tint_color', full_name='main.organization_service.OrganizationService.Containers.Organization.tint_color', index=4,
...
_ORGANIZATIONSERVICE_CONTAINERS_TEAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='color', full_name='main.organization_service.OrganizationService.Containers.Team.color', index=7,
...
_ORGANIZATIONSERVICE_CONTAINERS_COLOR = _descriptor.Descriptor(
  name='Color',
  full_name='main.organization_service.OrganizationService.Containers.Color',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='red', full_name='main.organization_service.OrganizationService.Containers.Color.red', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='green', full_name='main.organization_service.OrganizationService.Containers.Color.green', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='blue', full_name='main.organization_service.OrganizationService.Containers.Color.blue', index=2,
...
_ORGANIZATIONSERVICE_CONTAINERS = _descriptor.Descriptor(
  ...
  nested_types=[_ORGANIZATIONSERVICE_CONTAINERS_ORGANIZATION, _ORGANIZATIONSERVICE_CONTAINERS_PATHPART, _ORGANIZATIONSERVICE_CONTAINERS_TEAM, _ORGANIZATIONSERVICE_CONTAINERS_ADDRESS, _ORGANIZATIONSERVICE_CONTAINERS_LOCATION, _ORGANIZATIONSERVICE_CONTAINERS_TEAMDESCENDANTS, _ORGANIZATIONSERVICE_CONTAINERS_COLOR, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_ORGANIZATIONSERVICE_CONTAINERS_ORGANIZATION.fields_by_name['tint_color'].message_type = _ORGANIZATIONSERVICE_CONTAINERS_COLOR
...
_ORGANIZATIONSERVICE_CONTAINERS_TEAM.fields_by_name['color'].message_type = _ORGANIZATIONSERVICE_CONTAINERS_COLOR
...
_ORGANIZATIONSERVICE_CONTAINERS_COLOR.containing_type = _ORGANIZATIONSERVICE_CONTAINERS
...
OrganizationService = _reflection.GeneratedProtocolMessageType('OrganizationService', (_message.Message,), dict(
  ...
  Containers = _reflection.GeneratedProtocolMessageType('Containers', (_message.Message,), dict(
    ...
    Color = _reflection.GeneratedProtocolMessageType('Color', (_message.Message,), dict(
      DESCRIPTOR = _ORGANIZATIONSERVICE_CONTAINERS_COLOR,
      __module__ = 'protobufs.organization_service_pb2'
      # @@protoc_insertion_point(class_scope:main.organization_service.OrganizationService.Containers.Color)
      ))
    ,
...
_sym_db.RegisterMessage(OrganizationService.Containers.Color)
