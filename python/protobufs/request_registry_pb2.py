...
_MEDIASERVICEREQUESTS = _descriptor.Descriptor(
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='upload_image', full_name='main.requests.MediaServiceRequests.upload_image', index=0,
...
_MEDIASERVICEREQUESTS.extensions_by_name['upload_image'].message_type = protobufs.media_service_pb2._MEDIASERVICE_UPLOADIMAGE_REQUEST
service_protobufs.soa_pb2.ActionRequestParams.RegisterExtension(_MEDIASERVICEREQUESTS.extensions_by_name['upload_image'])
