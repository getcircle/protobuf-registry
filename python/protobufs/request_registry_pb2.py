...
_USERSERVICEREQUESTS = _descriptor.Descriptor(
  ...
  extensions=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bulk_update_users', full_name='main.requests.UserServiceRequests.bulk_update_users', index=11,
...
_USERSERVICEREQUESTS.extensions_by_name['bulk_update_users'].message_type = protobufs.user_service_pb2._USERSERVICE_BULKUPDATEUSERS_RESPONSE
service_protobufs.soa_pb2.ActionRequestParams.RegisterExtension(_USERSERVICEREQUESTS.extensions_by_name['bulk_update_users'])
