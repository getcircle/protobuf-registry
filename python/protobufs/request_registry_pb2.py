...
_LANDINGSERVICEREQUESTS = _descriptor.Descriptor(
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_extended_organization', full_name='main.requests.LandingServiceRequests.get_extended_organization', index=1,
...
_LANDINGSERVICEREQUESTS.extensions_by_name['get_extended_organization'].message_type = protobufs.landing_service_pb2._LANDINGSERVICE_GETEXTENDEDORGANIZATION_REQUEST
service_protobufs.soa_pb2.ActionRequestParams.RegisterExtension(_LANDINGSERVICEREQUESTS.extensions_by_name['get_extended_organization'])
