...
_PROFILESERVICEREQUESTS = _descriptor.Descriptor(
  ...
  extensions=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_trending_tags', full_name='main.requests.ProfileServiceRequests.get_trending_tags', index=14,
...
_PROFILESERVICEREQUESTS.extensions_by_name['get_trending_tags'].message_type = protobufs.profile_service_pb2._PROFILESERVICE_GETTRENDINGTAGS_REQUEST
service_protobufs.soa_pb2.ActionRequestParams.RegisterExtension(_PROFILESERVICEREQUESTS.extensions_by_name['get_trending_tags'])
