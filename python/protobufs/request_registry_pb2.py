...
_ORGANIZATIONSERVICEREQUESTS = _descriptor.Descriptor(
  ...
  extensions=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_location', full_name='main.requests.OrganizationServiceRequests.get_location', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='delete_location', full_name='main.requests.OrganizationServiceRequests.delete_location', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_extended_location', full_name='main.requests.OrganizationServiceRequests.get_extended_location', index=15,
...
_ORGANIZATIONSERVICEREQUESTS.extensions_by_name['delete_location'].message_type = protobufs.organization_service_pb2._ORGANIZATIONSERVICE_DELETELOCATION_REQUEST
service_protobufs.soa_pb2.ActionRequestParams.RegisterExtension(_ORGANIZATIONSERVICEREQUESTS.extensions_by_name['delete_location'])
