...
_ORGANIZATIONSERVICEREQUESTS = _descriptor.Descriptor(
  ...
  extensions=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_extended_location', full_name='main.requests.OrganizationServiceRequests.get_extended_location', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_locations', full_name='main.requests.OrganizationServiceRequests.get_locations', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='get_location', full_name='main.requests.OrganizationServiceRequests.get_location', index=15,
...
_ORGANIZATIONSERVICEREQUESTS.extensions_by_name['get_extended_location'].message_type = protobufs.organization_service_pb2._ORGANIZATIONSERVICE_GETEXTENDEDLOCATION_REQUEST
service_protobufs.soa_pb2.ActionRequestParams.RegisterExtension(_ORGANIZATIONSERVICEREQUESTS.extensions_by_name['get_extended_location'])
