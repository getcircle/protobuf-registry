...
_RESUMESERVICEREQUESTS = _descriptor.Descriptor(
  ...
  extensions=[
    _descriptor.FieldDescriptor(
      name='bulk_create_education', full_name='main.requests.ResumeServiceRequests.bulk_create_education', index=0,
...
_RESUMESERVICEREQUESTS.extensions_by_name['bulk_create_education'].message_type = protobufs.resume_service_pb2._RESUMESERVICE_BULKCREATEEDUCATION_REQUEST
service_protobufs.soa_pb2.ActionRequestParams.RegisterExtension(_RESUMESERVICEREQUESTS.extensions_by_name['bulk_create_education'])
