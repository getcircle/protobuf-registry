...
# source: user_service/valid_user.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='user_service/valid_user.proto',
  package='main.user_service.valid_user',
  serialized_pb=_b('\n\x1duser_service/valid_user.proto\x12\x1cmain.user_service.valid_user\"\x1a\n\x07Request\x12\x0f\n\x07user_id\x18\x01 \x01(\t\"\x1a\n\x08Response\x12\x0e\n\x06\x65xists\x18\x01 \x01(\x08')
)
...
Request = _reflection.GeneratedProtocolMessageType('Request', (_message.Message,), dict(
  DESCRIPTOR = _REQUEST,
  __module__ = 'user_service.valid_user_pb2'
