...
_USERSERVICE = _descriptor.Descriptor(
  ...
  nested_types=[_USERSERVICE_CONTAINERS, _USERSERVICE_CREATEUSER, _USERSERVICE_GETUSER, _USERSERVICE_VALIDUSER, _USERSERVICE_AUTHENTICATEUSER, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
