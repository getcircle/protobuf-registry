...
_USERSERVICE = _descriptor.Descriptor(
  ...
  nested_types=[_USERSERVICE_CONTAINERS, _USERSERVICE_CREATEUSER, _USERSERVICE_UPDATEUSER, _USERSERVICE_GETUSER, _USERSERVICE_VALIDUSER, _USERSERVICE_AUTHENTICATEUSER, _USERSERVICE_SENDVERIFICATIONCODE, _USERSERVICE_VERIFYVERIFICATIONCODE, _USERSERVICE_GETAUTHORIZATIONINSTRUCTIONS, _USERSERVICE_COMPLETEAUTHORIZATION, _USERSERVICE_GETIDENTITIES, ],
  enum_types=[
