...
_RESUMESERVICE_CONTAINERS = _descriptor.Descriptor(
  ...
  nested_types=[_RESUMESERVICE_CONTAINERS_RESUME, _RESUMESERVICE_CONTAINERS_EDUCATION, _RESUMESERVICE_CONTAINERS_POSITION, _RESUMESERVICE_CONTAINERS_COMPANY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
