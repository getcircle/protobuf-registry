...
_RESUMESERVICE_CONTAINERS_POSITION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_current', full_name='main.resume_service.ResumeService.Containers.Position.is_current', index=7,
