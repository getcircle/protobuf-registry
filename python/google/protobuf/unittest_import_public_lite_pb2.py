...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/protobuf/unittest_import_public_lite.proto',
...
PublicImportMessageLite = _reflection.GeneratedProtocolMessageType('PublicImportMessageLite', (_message.Message,), dict(
  DESCRIPTOR = _PUBLICIMPORTMESSAGELITE,
  __module__ = 'google.protobuf.unittest_import_public_lite_pb2'
